...
import com.agi.core.User;
import com.agi.payload.request.LoginRequest;
import com.agi.payload.request.SignupRequest;
import com.agi.payload.response.JwtResponse;
...
import com.agi.security.JwtUtils;
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        if (strRoles == null) {
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        Role adminRole = roleRepository.findByName(ERole.ROLE_ADMINISTATEUR)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(adminRole);
